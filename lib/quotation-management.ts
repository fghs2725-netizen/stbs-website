  ...
  return prisma.$transaction(async tx=>{
    ...
    return state(await tx.quotation.create({
      data:{
        ...
        clientPinCode:x.clientPinCode,clientPhone:x.clientPhone,clientEmail:x.clientEmail,clientGstin:x.clientGstin,discountType:x.discountType,discountValue:x.discountValue,gstEnabled:x.gstEnabled,gstMode:x.gstMode,gstRate:x.gstRate,

  ...
  return (
    <div className="space-y-6 h-full flex flex-col">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <Link href="/admin/documents/new">
            <button className="flex items-center px-4 py-2 bg-signal text-ink text-sm font-bold rounded-lg hover:bg-signal/90 transition-colors">
      ...
      <div className="bg-steel/60 backdrop-blur-xl border border-white/10 rounded-2xl flex-1 flex flex-col overflow-hidden">
        <form method="GET" action="/admin/documents" className="p-4 border-b border-white/5 flex flex-col md:flex-row gap-4">
          ...
          <div className="flex gap-3">
            <select name="type" defaultValue={typeFilter} className="bg-surface border border-white/10 rounded-lg px-4 py-2 text-sm text-gray-300 focus:outline-none focus:border-signal/50 appearance-none min-w-[140px]">
            ...
            <select name="status" defaultValue={statusFilter} className="bg-surface border border-white/10 rounded-lg px-4 py-2 text-sm text-gray-300 focus:outline-none focus:border-signal/50 appearance-none min-w-[140px]">
            ...
            <button type="submit" className="px-4 py-2 bg-surface border border-white/10 rounded-lg text-sm text-white hover:bg-white/5 transition-colors">
              Apply
            </button>
          </div>
        </form>

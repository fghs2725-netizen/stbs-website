...
const sectors = [[Home, "Residential"], [Sprout, "Agriculture"], [Building2, "Commercial"], [Factory, "Industrial"], [Landmark, "Institutional"], [Warehouse, "Infrastructure"]] as const;

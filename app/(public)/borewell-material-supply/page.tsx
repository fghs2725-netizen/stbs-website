...
export default function BorewellMaterialSupply() { return <ServiceDetailPage eyebrow="Material supply" title="Borewell Material Supply You Can Rely On" intro="Material support for borewell work, selected around fit, durability and the requirements of the planned installation." icon={Boxes} bullets={["Casing pipes suited to the bore diameter and depth", "Pump sets matched to the water table and usage", "Fittings and connectors for the installation", "Panels and control equipment as required"]} image="/services/borewell-material-supply-yard.webp" imageAlt="Casing pipes, cable drums and submersible pump motors stacked under cover in a supply yard"/>; }

...
import { LayoutDashboard, FileText, LifeBuoy, LogOut } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="hidden sm:ml-6 sm:flex sm:items-center space-x-4">
              <Link href="/portal/support" className="text-gray-500 hover:text-gray-700 p-2 rounded-full hover:bg-gray-100 transition-colors">
